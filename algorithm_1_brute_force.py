# -*- coding: utf-8 -*-
"""
Created on Thu Mar 17 14:50:40 2022
...
# def argmin(N, theta):
#     
#     # PRE :   accross -> values accros we minimize
#     #         theta_i -> 
#     #         N -> Instance of the problem
#     
#     #POST : returns the argmin 
#     
#     # TEsting: seems to work well, the temporary minima go down
#     
#     
#     argmin = 0
#     accross = list(powerset(N.S_plus + N.S_minus))
...
#     
#     for i in accross:
#         temp = d_theta_S(N, theta, i)
#         if temp < curr_min : 
#             curr_min = temp
#             argmin = i
#            # print("new argmin :  " + str(argmin))
#         #print(curr_min)
#     
#     d_theta = curr_min
#     
